...
void ViewerWidget::paintGL()
{
  ...
  if (model) {
    ...
    glm::mat4 view = glm::lookAt(eye * viewDistance, glm::vec3(0.f, 0.f, 0.f),
    ...
    vc.rotation =
        glm::angleAxis(glm::half_pi<float>() + viewAngles.x, glm::vec3(0.f, 0.f, 1.f)) *
...
{
  QString toSv = QFileDialog::getSaveFileName(this, "Export Model", QDir::homePath(),
                                              "Model (*.DFF)");
