...
template <>
ScriptFloat& ScriptArguments::getParameterRef<ScriptFloat>(unsigned int arg) const
{
...
template <>
ScriptObjectType<VehicleObject> ScriptArguments::getScriptObject(unsigned int arg) const
{
  auto& param = (*this)[arg];
...
template <>
ScriptObjectType<InstanceObject> ScriptArguments::getScriptObject(unsigned int arg) const
{
  auto& param = (*this)[arg];
  RW_CHECK(param.isLvalue(), "Non lvalue passed as object");
...
template <>
ScriptObjectType<CharacterObject> ScriptArguments::getScriptObject(unsigned int arg) const
{
  auto& param = (*this)[arg];
  RW_CHECK(param.isLvalue(), "Non lvalue passed as object");
...
template <>
ScriptObjectType<PickupObject> ScriptArguments::getScriptObject(unsigned int arg) const
{
  auto& param = (*this)[arg];
  RW_CHECK(param.isLvalue(), "Non lvalue passed as object");
...
template <>
ScriptObjectType<GarageInfo> ScriptArguments::getScriptObject(unsigned int arg) const
{
  auto& param = (*this)[arg];
  RW_CHECK(param.isLvalue(), "Non lvalue passed as object");
...
template <>
ScriptObjectType<BlipData> ScriptArguments::getScriptObject(unsigned int arg) const
{
  auto& param = (*this)[arg];
  RW_CHECK(param.isLvalue(), "Non lvalue passed as object");
