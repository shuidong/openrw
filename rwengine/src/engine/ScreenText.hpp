...
struct ScreenTextEntry {
  ...
  static ScreenTextEntry makeBig(const GameStringKey& id, const GameString& str,
                                 int style, int durationMS);

  static ScreenTextEntry makeHighPriority(const GameStringKey& id, const GameString& str,
                                          int durationMS);

  static ScreenTextEntry makeHelp(const GameStringKey& id, const GameString& str);
};
