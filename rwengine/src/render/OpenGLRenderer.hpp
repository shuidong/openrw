...
public:
  ...
  struct DrawParameters {
    ...
    DrawParameters()
        : blend(false), depthWrite(true), ambient(1.f), diffuse(1.f), visibility(1.f)
    {
    }
  };
  ...
  virtual void setProgramBlockBinding(ShaderProgram* p, const std::string& name,
                                      GLint point) = 0;
...
/// @todo set blendEnabled, currently not possible because other functions keep trashing
/// the state
#if 0
